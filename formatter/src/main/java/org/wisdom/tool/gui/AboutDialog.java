...
public class AboutDialog extends JDialog implements ActionListener
{
    ...
    * @throws
    ...
    private void init()
    {
        this.setTitle(FormatConst.ABOUT_TOOL);
        ...
        JLabel lblTitle = new JLabel("<html><h3>" + FormatConst.FORMAT_VERSION + "</h3></html>");
        ...
        tp.setText(FormatUtil.contents(FormatConst.WISDOM_TOOL_ORG));
